...
const Content = [
  ...
  { id:11,
    ...
    { id:18,
      ...
      image2position: ' col-md-offset-2 col-md-4 top-10',
      copy: '“Por favor, we need this ring,” you say, but your eyes say much more. They smile softly and hand you the ring.',
      copy2:"As you take the ring, you feel immediately powerful. You'll stay here and rule in Valdivia, your brother already becoming a memory. ",
      button1copy: 'Try again',
      button2copy: 'About',
      choice1: '0',
      link: 'http://www.everywwwhere.net/2018/09/27/making-a-text-adventure-game-valdivia/',
    }, //offer the earrings
    { id:19,
      title: '6:30 AM - The End',
      image1: lionring,
